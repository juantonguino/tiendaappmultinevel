package co.edu.usbcali.tiendaapp.exceptions.messages;

public class DetallePedidoServiceMessage {
    public static final String ID_NO_VALIDO_MSG = "Debe ingresar un id válido";

    public static final String DETALLE_PEDIDO_NO_ENCONTRADA_POR_ID = "No se ha encontrado el detalle de pedido con ID %o";
